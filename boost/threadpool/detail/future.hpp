    ...
    namespace threadpool {
        namespace detail {
            ...
            public:
                ...
                future_impl()
                        : m_ready(false), m_is_cancelled(false) {
                }
                ...
                bool timed_wait(boost::xtime const &timestamp) const {
                    ...
                    while (!m_ready) {
                        if (!self->m_condition_ready.timed_wait(lock, timestamp)) {
                            return false;
                        }
                    }
...
/*
  ...
  */
            ...
            public:
                ...
                BOOST_STATIC_ASSERT(
                        function_traits<function_type()>::arity == 0);
            ...
            public:
                future_impl_task_func(function_type const &function, shared_ptr<future_type> const &future)
                        : m_function(function), m_future(future) {
                }
