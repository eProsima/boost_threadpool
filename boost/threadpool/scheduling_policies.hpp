...
namespace boost {
    namespace threadpool {
        ...
        *
        */
        template<template<typename> class Task = task_functor, typename TaskReturnType = void>
        class fifo_scheduler {
        public:
            using task_type = Task<TaskReturnType>; //!< Indicates the scheduler's task type.
        ...
        *
        */
        template<template<typename> class Task = priority_task_functor, typename TaskReturnType = void>
